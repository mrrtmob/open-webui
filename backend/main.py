...
async def update_model_filter_config(
    ...
    settings_to_save = [
        AdminSettingsModel(name="ENABLE_MODEL_FILTER", value=str(app.state.config.ENABLE_MODEL_FILTER)),
        AdminSettingsModel(name="MODEL_FILTER_LIST", value=json.dumps(app.state.config.MODEL_FILTER_LIST)),
    ]
